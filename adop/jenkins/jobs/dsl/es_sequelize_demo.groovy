...
// Variables
def referenceAppGitRepo = "es2017-sequelize-demo"
...
// Views
def pipelineView = buildPipelineView(projectFolderName + "/Example_es2017-sequelize-demo_Pipeline")

pipelineView.with{
    title('Example es2017-sequelize-demo Pipeline')
    displayedBuilds(5)
